...
enum SyberiaSkillType {
	...
	SYBSKILL_HUNTING = 8,
	SYBSKILL_FISHING = 9,
	SYBSKILL_MECHANICS = 10,
	SYBSKILL_ELECTRONICS = 11,
	SYBSKILL_CARPENTRY = 12,
	SYBSKILL_METALWORKING = 13,
	SYBSKILL_BUILDING = 14,
	SYBSKILL_FIREARMS = 15,
	SYBSKILL_LOCKPICKING = 16,
	SYBSKILL_HERBALISM = 17,
	SYBSKILL_SEAMSTRESS = 18,
	
	// Total count of all skills (internal use only)
	SYBSKILL_TOTALCOUNT = 19
};
