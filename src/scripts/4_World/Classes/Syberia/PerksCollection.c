...
class PerksCollection
{
	...
	protected void OnInit()
	{
		...
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_MENTAL_TIME, "%").AddUnlockValue(5, 5).AddUnlockValue(15, 10).AddUnlockValue(25, 20).AddUnlockValue(36, 30).AddUnlockValue(57, 40).AddUnlockValue(100, 60);
