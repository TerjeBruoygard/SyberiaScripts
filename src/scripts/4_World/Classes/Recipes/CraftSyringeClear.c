class CraftSyringeClear extends RecipeBase
{
	override void Init()
	{
		m_Name = "#syb_syringe_clear_action";
	...
	{
		MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[0], "SyringeEmpty", player));
	}
};
